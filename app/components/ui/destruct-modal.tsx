    ...
    >
      ...
      >
        <DialogPanel className={"dialogPanel"}>
          <DialogTitle className={"dialogTitle"}>{action}</DialogTitle>

          <div className={"dialogText"}>This action cannot be undone.</div>
          ...
          <div className={"buttonGroup"}>
            <div className="buttons">
              ...
              <Button
                aria-label={action}
                variant={
                  action.includes("Blacklist") ? "destructive" : "default"
                }
                disabled={isPending}
