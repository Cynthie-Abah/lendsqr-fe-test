...
function TableHeader(props: React.ComponentProps<'thead'>) {
  return (
    <thead data-slot="table-header" className="table-header" {...props} />
  );
}

function TableBody(props: React.ComponentProps<'tbody'>) {
  return (
    <tbody data-slot="table-body" className="table-body" {...props} />
  );
}

function TableFooter(props: React.ComponentProps<'tfoot'>) {
  return (
    <tfoot data-slot="table-footer" className="table-footer" {...props} />
  );
}

function TableRow(props: React.ComponentProps<'tr'>) {
  return (
    <tr data-slot="table-row" className="table-row" {...props} />
  );
}

function TableHead(props: React.ComponentProps<'th'>) {
  return (
    <th data-slot="table-head" className="table-head" {...props} />
  );
}

function TableCell(props: React.ComponentProps<'td'>) {
  return (
    <td data-slot="table-cell" className="table-cell" {...props} />
  );
}
